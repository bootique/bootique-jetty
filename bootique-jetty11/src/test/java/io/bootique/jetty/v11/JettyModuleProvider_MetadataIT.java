...
public class JettyModuleProvider_MetadataIT {
    ...
    public void testMetadata() {
        ...
        assertEquals("jetty" +
                "[compactPath:boolean]" +
                "[compression:boolean]" +
                "[list:connectors<io.bootique.jetty.v11.connector.ConnectorFactory>]" +
                "[context:java.lang.String]" +
                "[map:errorPages<java.lang.Integer,java.lang.String>]" +
                "[map:filters<java.lang.String,io.bootique.jetty.v11.server.FilterFactory>]" +
                ...
                "[map:servlets<java.lang.String,io.bootique.jetty.v11.server.ServletFactory>]" +
                "[sessions:boolean]" +
