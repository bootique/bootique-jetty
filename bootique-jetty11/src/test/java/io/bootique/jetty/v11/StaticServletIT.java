        ...
        testFactory.app("-s")
                .module(b -> {
                    ...
                    BQCoreModule.extend(b).setProperty("bq.jetty.staticResourceBase",
                            "src/test/resources/io/bootique/jetty/v11/StaticResourcesIT_docroot_subfolders/");
                })
                .run();
                ...
                .module(b -> {
                    ...
                    BQCoreModule.extend(b)
                            ...
                            .setProperty("bq.jetty.staticResourceBase",
                                    "src/test/resources/io/bootique/jetty/v11/ResourcePathResolving/")
                            ...
                            .setProperty("bq.jetty.servlets.s1.params.resourceBase",
                                    "src/test/resources/io/bootique/jetty/v11/ResourcePathResolving/root1/")
                            ...
                            .setProperty("bq.jetty.servlets.s2.params.resourceBase",
                                    "src/test/resources/io/bootique/jetty/v11/ResourcePathResolving/root2/")
    ...
    public void testResourceBaseClasspath_Missing() {
        ...
        CommandOutcome run = testFactory.app("-s")
                .module(b -> {
                    ...
                    BQCoreModule.extend(b)
                            .setProperty("bq.jetty.servlets.s1.params.resourceBase",
                                    "classpath:io/bootique/jetty/v11/no_such_folder/");
                })
                .run();
        ...
        testFactory.app("-s")
                .module(b -> {
                    ...
                    BQCoreModule.extend(b)
                            ...
                            .setProperty("bq.jetty.servlets.s1.params.resourceBase",
                                    "classpath:io/bootique/jetty/v11/ResourcePathResolving/root1/");
                })
                .run();
