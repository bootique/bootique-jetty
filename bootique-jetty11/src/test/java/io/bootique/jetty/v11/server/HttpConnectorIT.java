...
public class HttpConnectorIT {
    ...
    public void testMultipleConnectors() {
        ...
        BQRuntime app = startJetty("classpath:io/bootique/jetty/v11/server/HttpConnectorIT_multipleConnectors.yml");
    ...
    public void testDynamicPort() {
        ...
        BQRuntime app = startJetty("classpath:io/bootique/jetty/v11/server/HttpConnectorIT_dynamicPort.yml");
