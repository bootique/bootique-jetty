...
public class DefaultServletIT {
        ...
        testFactory.app("-s")
                .module(b -> {
                    ...
                    BQCoreModule.extend(b).setProperty("bq.jetty.staticResourceBase",
                            "src/test/resources/io/bootique/jetty/jakarta/StaticResourcesIT_docroot/");
                })
                .createRuntime()
                .run();
                ...
                .module(b -> {
                    ...
                    BQCoreModule.extend(b)
                            ...
                            .setProperty("bq.jetty.servlets.default.params.resourceBase",
                                    "src/test/resources/io/bootique/jetty/jakarta/StaticResourcesIT_altdocroot/");
                })
                .run();
    ...
    public void testDefaultServlet_ResourceBaseIsFileUrl() throws MalformedURLException {
        ...
        File baseDir = new File("src/test/resources/io/bootique/jetty/jakarta/StaticResourcesIT_docroot/");
    ...
    public void testDefaultServlet_ResourceBaseIsClasspathUrl() {
        ...
        testFactory.app("-s")
                .module(b -> {
                    JettyModule.extend(b).useDefaultServlet();
                    BQCoreModule.extend(b).setProperty("bq.jetty.staticResourceBase",
                            "classpath:io/bootique/jetty/jakarta/StaticResourcesIT_docroot");
                })
                .run();
