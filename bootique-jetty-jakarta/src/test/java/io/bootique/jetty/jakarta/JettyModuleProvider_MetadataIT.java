...
public class JettyModuleProvider_MetadataIT {
    ...
    public void testMetadata() {
        ...
        assertEquals("jetty" +
                "[compactPath:boolean]" +
                "[compression:boolean]" +
                "[list:connectors<io.bootique.jetty.jakarta.connector.ConnectorFactory>]" +
                "[context:java.lang.String]" +
                "[map:errorPages<java.lang.Integer,java.lang.String>]" +
                "[map:filters<java.lang.String,io.bootique.jetty.jakarta.server.FilterFactory>]" +
                ...
                "[map:servlets<java.lang.String,io.bootique.jetty.jakarta.server.ServletFactory>]" +
                "[sessions:boolean]" +
